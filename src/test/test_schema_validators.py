...
def test_jsonschema(method, url, json_schema, api_session):
    ...
    validate_json_schema(data=response.json(), schema_filename=json_schema)
...
def test_voluptuous_soft_assertion():
    ...
    response_list = [
        ...
        {'data': {'firstName': 'Albus', 'lastName': 'Dumbdoor'}},
        {'data': {'first_name': 100, 'last_name': None}},
    ]
